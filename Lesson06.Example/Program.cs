...
namespace Lesson06.Example
{
    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Enter price of phone 1: ");
            float fltPrice = float.Parse(Console.ReadLine());
            objP1= new Phone(strModel, fltPrice);

            Console.WriteLine("Enter the model of phone 2: ");
            strModel = Console.ReadLine();
            Console.WriteLine("Enter price of phone 2: ");
            ...
            Console.WriteLine("Total nmber of phone = {0}.", 
Phone.intCount);
